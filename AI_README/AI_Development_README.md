...
│   │
│   ├── Water/                      ✅ 已完成
│   │   ├── Water.h/cpp             ✅ 已完成 (水面渲染)
│   │   ├── WaterFramebuffers.h/cpp ✅ 已完成 (反射/折射FBO)
│   │   └── WaveGenerator.h/cpp     ⏳ 待开发 (可选)
│   │
│   ├── Environment/                ✅ 已完成
...
│   ├── terrain.vert/frag           ✅ 已完成 (多纹理混合、光照、裁剪平面)
│   ├── skybox.vert/frag            ✅ 已完成 (立方体贴图采样、裁剪平面)
│   ├── water.vert/frag             ✅ 已完成 (Fresnel/反射/折射)
│   └── common/                     ✅ 已创建 (空)
│       └── lighting.glsl           ⏳ 待开发
│
├── assets/                         ✅ 已创建
...
| **天空盒着色器** | ✅ 已完成 | 立方体贴图采样、深度设为最远、裁剪平面支持 |
| **WaterFramebuffers** | ✅ 已完成 | 反射/折射FBO管理、颜色/深度纹理创建 |
...
| 4.5 波浪动画 | DuDv纹理扭曲 + 程序化波浪 | ✅ |
| 4.6 岸边泡沫 | 基于深度的泡沫效果 | ⏳ 可选 |
